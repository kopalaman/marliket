...
import AddProfileInfo from "@/components/profile/add-info"
...
export default function VendorRegistrationPage() {
  return (
    <div className="relative bg-gradient-to-bl from-primary-foreground via-primary-foreground to-background">
      <div className="container py-3 sm:py-24">
        {/* Grid */}
        <div className="grid items-start gap-8 lg:gap-12 xl:grid-cols-2">
          <div>
            <Button variant="secondary" className="my-5 block">
              <Link href={Routes.sell} className="flex items-center">
            ...
            <div className="mt-4 max-w-2xl md:mb-12">
              ...
              <p className="text-xl text-muted-foreground">
                Experience limitless business possibilities with one of the kind
                online commerce platform. Go online and see your business grow.
              </p>
            </div>
            {/* End Title */}
            {/* Blockquote */}
        ...
        <div className="mt-6 flex items-center gap-x-1.5 py-3 text-sm text-muted-foreground after:ms-6 after:flex-[1_1_0%] after:border-t after:border-t-muted-foreground/50 md:mt-12">
          ...
          individuals and companies trust Marliket commerce
        </div>
        {/* Clients */}
