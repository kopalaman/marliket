...
export default function BannerBlock({
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "4xl:px-40 4xl:py-[88px] relative md:px-12 md:py-12 lg:px-14 xl:px-20 xl:py-16 3xl:px-32 3xl:py-20",
          className
        )}
      >
        <Image
          ...
          className={clsx(
            "bg-gray-lighter aspect-[18/5] object-cover md:max-h-full md:rounded-2xl",
            bgImgClassName
          )}
          quality={100}
          fill
