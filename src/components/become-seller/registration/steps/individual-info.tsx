...
const individualInfoSchema = z.object({
  ...
  nationalId: z
    ...
    .regex(/^\d{6}\/\d{2}\/\d{1}$/, "Please enter a valid national ID"),
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <Card className="p-6 shadow-lg">
              <div className="grid gap-6">
                ...
                <CustomFormField
                  ...
                  name="taxpinNumber"
                  control={form.control}
                  placeholder="Enter your Tax PIN number"
                />
            ...
            <Card className="p-6 shadow-lg">
              <div className="space-y-6">
                ...
                {/* <TooltipContent>
                    <p>
                      If you&apos;re a member of a vehicle sellers association,
                      enter the name here. This can help verify your
                      credentials.
                    </p>
                  </TooltipContent> */}
